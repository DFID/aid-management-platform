...
$(function(){
  ...
  function Add_row(){
    $("#tblOutputDesc tbody").append(
      ...
      "<td><input type='text'/></td>"+
      "<td><input type='text'/></td>"+
      "<td><img src='../Content/Images/disk.png' class='btnSave_row'><img src='../Content/Images/delete.png' class='btnDelete_row'/></td>" +
      "</tr>");
  ...
  function Edit_row(){
    ...
    td_Ctrl.html("<img src='../Content/Images/disk.png' class='btnSave_row'/>");
  ...
  function Save_row(){
    ...
    td_Ctrl.html("<img src='../Content/Images/delete.png' class='btnDelete_row'/><img src='../Content/Images/pencil.png' class='btnEdit_row'/>");
    $(".btnEdit_row").bind("click", Edit_row);
    $(".btnDelete_row").bind("click", Delete_row);
  };
